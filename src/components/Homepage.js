        ...
        <div className="wrapper">
          <section className="about-container">
            <div className="about-item">
              <h3>Collect</h3>
              <p>Aggregate resources found online</p>
            </div>
            <div className="about-item middle-item">
              <h3>Discover</h3>
              <p>Explore articles via the New York Times API</p>
            </div>
            <div className="about-item">
              <h3>Analyze</h3>
              <p>Visualize your findings using Chart.js</p>
            </div>
          </section>
          <section className="made-with-container">
            <div className="made-with-item react">
              <p id="react-text">User interface developed with React</p>
              <svg
                id="react-logo"
                version="1.1"
                height="155px"
            ...
            <div className="made-with-item redux">
              ...
              <p id="redux-text">Application state managed with Redux</p>
            </div>
          </section>
        </div>
      </div>
